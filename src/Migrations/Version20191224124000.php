 ...
 */
final class Version20191224124000 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE klo_ki_event (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, start DATETIME NOT NULL, "end" DATETIME DEFAULT NULL, anzahl_artists INTEGER DEFAULT NULL, is_best_benoetigt BOOLEAN NOT NULL, is_licht_benoetigt BOOLEAN NOT NULL, bemerkung CLOB DEFAULT NULL, is_fixed BOOLEAN NOT NULL, is_ton_benoetigt BOOLEAN NOT NULL, helper_required BOOLEAN NOT NULL, all_day BOOLEAN DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, art_id INTEGER NOT NULL, kategorie_id INTEGER NOT NULL, kontakt_id INTEGER NOT NULL, best_plan_id INTEGER DEFAULT NULL, room_id INTEGER NOT NULL, parent_event_id INTEGER DEFAULT NULL, created_by INTEGER DEFAULT NULL, updated_by INTEGER DEFAULT NULL, stage_order_id INTEGER DEFAULT NULL, helper_einlass_eins_id INTEGER DEFAULT NULL, helper_einlass_zwei_id INTEGER DEFAULT NULL, helper_kasse_id INTEGER DEFAULT NULL, helper_springer_eins_id INTEGER DEFAULT NULL, helper_springer_zwei_id INTEGER DEFAULT NULL, licht_techniker_id INTEGER DEFAULT NULL, ton_techniker_id INTEGER DEFAULT NULL)');
